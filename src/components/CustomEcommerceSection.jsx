...
const technologies = ["React Native", "Node.js", "MongoDB", "Socket.io"];
...
const technologies2 = ["Flutter", "Firebase", "Google Fit API", "HealthKit"];

const faqData = [
  {
    question: "1. What is custom ecommerce website development?",
    answer:
      "Custom ecommerce website development builds an online store tailored to your business workflows, integrations, and customer experience—offering flexibility beyond templates.",
  },
  {
    question: "2. Which platform is best — Shopify or headless ecommerce?",
    answer:
      "For speed to market, Shopify custom development is ideal. For complex, large-scale needs or omnichannel experiences, headless ecommerce provides maximum flexibility.",
  },
  {
    question: "3. Which platform is best — Shopify or headless ecommerce?",
    answer:
      "For speed to market, Shopify custom development is ideal. For complex, large-scale needs or omnichannel experiences, headless ecommerce provides maximum flexibility.",
  },
  {
    question: "4. Do you handle payment and tax integrations for India?",
    answer:
      "Yes. We integrate Razorpay, PayU, Stripe (global) and configure GST-friendly invoicing and tax rules.",
  },
  {
    question: "5. How long does a custom ecommerce project take?",
    answer:
      "Timelines vary: starter stores ~6–12 weeks; growth stores 8–16 weeks; enterprise/headless solutions 3–6+ months.",
  },
  {
    question: "6. Do you offer post-launch support?",
    answer:
      "Yes — managed hosting, maintenance, CRO, and analytics services to help you scale.",
  },
];
      ...
      <section className="">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7 ">
          <div className="gap-6 pt-[30px]  pl-4 xl:pl-[56px] lg:pl-[50px] md:pl-8  md:pr-[0px]">
            ...
            <p className="mt-6">
              End-to-end custom ecommerce development — from Shopify custom
              development to headless commerce and enterprise marketplaces.
            ...
            <div className="mt-8 ">
              ...
              <div className="flex items-start gap-2 mt-2 ">
                <CircleCheckBig className="w-6 h-6 text-green-600" />
                <p className="text-[17px]">
                  Payment, tax & marketplace integrations for India & global
                  markets
                </p>
              </div>
              <div className="flex items-start gap-2 mt-2 ">
        ...
        <div className="container mx-auto py-4 md:py-16">
          <div className="flex flex-col gap-3">
            <h2 className="max-w-4xl mx-auto text-center">
              Why businesses choose our custom ecommerce website development
              company
            </h2>
            <p className="max-w-5xl mx-auto text-center text-[#383030]">
              We’re a results-driven ecommerce website development agency that
              builds stores focused on revenue, user experience and long-term
              growth. Whether you need a fast Shopify launch, a robust headless
              ecommerce solution, or a custom marketplace, our team delivers
            ...
            {whyChooseUs.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-[20px] mt-6">{item.title}</h3>
          ...
          <div className="flex justify-between flex-wrap gap-0 max-w-[1100px] mx-auto mt-5">
            {[
              ...
              },
              {
                ...
                subtitle: "Design, mobile-first prototypes",
              },
              {
                icon: Code,
        ...
        <div className="container mx-auto md:py-16 pt-4">
          <div className="flex flex-col gap-3 py-4 ">
            ...
            <p className="max-w-[60%] mx-auto text-center text-[18px]">
              ...
              transform their ideas into successful mobile applications that
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <p className="text-[16px] text-[#525D6A] font-semibold">
                  Client needed a comprehensive food deliv ery platform to
                  compete with major players in the market.
                </p>
                <h4 className="font-semibold text-[24px]">Challenge</h4>
                <p className="text-[16px] text-[#525D6A] font-semibold">
                  Client needed a comprehensive food deliv ery platform to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-16 md:mt-20">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <h4 className="font-semibold text-[24px]">Challenge</h4>
                <p className="text-[16px] text-[#525D6A] font-semibold">
                  Creating a HIPAA-compliant health monitoring app with complex
                  data visualization.
                </p>

                <h4 className="font-semibold text-[24px]">Solution</h4>
                <p className="text-[16px] text-[#525D6A] font-semibold">
                  Built a secure, analytics-driven platform with wearable
                  integration.
                </p>
          ...
          <div className="text-center mt-6 md:mt-12">
            <div className="inline-block">
              <button className="text-white py-4 px-6 bg-[#1E8767] font-[var(--font-inter)] rounded-md cursor-pointer hover:bg-[#166c52] transition-colors duration-300">
